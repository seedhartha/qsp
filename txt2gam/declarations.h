...
/* MEMWATCH */
	...
	#define QSP_DEFINES
		...
		#define QSP_UCSLE2TOB
		#define QSP_BTOUCS2LE
	#else
		...
		#define QSP_UCSLE2TOB(a) qspReverseConvertUCS2LE(a, qspCP1251ToUCS2LETable)
		#define QSP_BTOUCS2LE(a) qspDirectConvertUCS2LE(a, qspCP1251ToUCS2LETable)
	#endif
